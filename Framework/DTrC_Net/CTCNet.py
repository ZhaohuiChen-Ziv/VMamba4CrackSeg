...
from .deit import deit_tiny_distilled_patch16_256, deit_tiny_patch16_256
...
class CTCNet(nn.Module):
    ...
    def forward(self, x):
        ...
        feature_tf = feature_tf.view(b, size, 28, 28)
